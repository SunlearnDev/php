                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="advanced-search">
                            ...
                            <form action="search.php" class="input-group" method="POST">
                                <input type="search" name="search-value" placeholder="What do you need?">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        <a href="shop.php"><i class="fa fa-home"></i> Home</a>
                        <span>Shop</span>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 order-1 order-lg-2">
                    <div class="product-list">
                        <div class="row">
                            ...
                            $rquery = "SELECT * FROM products WHERE name LIKE ?";
                            $connet = mysqli_prepare($conn, $rquery);
                            $searchValude = "%$search%";
                            mysqli_stmt_bind_param($connet, 's', $searchValude);
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="product-item">
                                            <div class="pi-pic" style="height: 435px;">
                                                <a href="product-detail.php?id=<?php echo $kq['id']; ?>">
